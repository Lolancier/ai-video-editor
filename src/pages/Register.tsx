    ...
    try {
      ...
      if (data.user) {
          ...
          .insert([
            {
              id: data.user.id,
              email: email,
              password_hash: 'managed_by_supabase', // In a real app we might not need this if using Supabase Auth exclusively
              name: name,
            },
          ]);
        ...
        if (dbError) {
          ...
          // Don't throw here, the auth user is created
        }
    ...
    <div className="flex min-h-[80vh] items-center justify-center">
      <div className="w-full max-w-md space-y-8 bg-white p-8 rounded-xl shadow-lg border border-slate-100">
        <div className="text-center">
          <h2 className="mt-6 text-3xl font-bold tracking-tight text-slate-900">注册新账号</h2>
          ...
          <div className="-space-y-px rounded-md shadow-sm">
            ...
            <div>
              <input
                type="email"
                required
                className="relative block w-full border-0 py-1.5 text-slate-900 ring-1 ring-inset ring-slate-300 placeholder:text-slate-400 focus:z-10 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6 px-3"
                placeholder="邮箱地址"
                value={email}
